...
import dong.lan.shundai.ui.ImageBrowserActivity;
import dong.lan.shundai.ui.LocationActivity;
...
public class MessageChatAdapter extends BaseListAdapter<BmobMsg> {
	...
	public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		if(avatar!=null && !avatar.equals("")){//加载头像-为了不每次都加载头像
			ImageLoader.getInstance().displayImage(avatar, iv_avatar, ImageLoadOptions.getOptions(1),animateFirstListener);
		}else{
