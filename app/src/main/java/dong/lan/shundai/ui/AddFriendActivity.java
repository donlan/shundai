...
import dong.lan.shundai.adapter.AddFriendAdapter;
...
public class AddFriendActivity extends ActivityBase implements OnClickListener,XListView.IXListViewListener,OnItemClickListener{
	...
	private void initSearchList(final boolean isUpdate){
		...
		userManager.queryUserByPage(isUpdate, 0, searchName, new FindListener<User>() {
	...
	private void queryMoreSearchList(int page){
		userManager.queryUserByPage(true, page, searchName, new FindListener<User>() {
