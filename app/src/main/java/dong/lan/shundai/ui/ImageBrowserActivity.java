...
import dong.lan.shundai.view.CustomViewPager;
...
public class ImageBrowserActivity extends BaseActivity implements OnPageChangeListener {
	...
	private class ImageBrowserAdapter extends PagerAdapter {
		...
		public View instantiateItem(ViewGroup container, int position) {
	        ...
	        ImageLoader.getInstance().displayImage(imgUrl, photoView, ImageLoadOptions.getOptions(0),new SimpleImageLoadingListener() {
